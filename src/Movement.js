class Movement extends Phaser.Scene {
    ...
    create() {
        ...
        this.player.body.setSize(32,32).setOffset(8,16); // changes the bounding box of the character
        ...
        this.anims.create({
            key: 'idle-down',
            frameRate: 0,
            repeat: -1,             //plays animation infinitely
        ...
        //this.player.play('walk-down');  <------ tests animation
        this.anims.create({
            key: 'walk-up',
            frameRate: 5,
            repeat: -1,             //plays animation infinitely
